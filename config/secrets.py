...
username = os.getenv("LINKEDIN_USERNAME", "sanjaynainwal129@gmail.com")  # Enter your username in the quotes
password = os.getenv("LINKEDIN_PASSWORD", "B@NGB@ng12")        # Enter your password in the quotes
...
# Select AI Provider
ai_provider = os.getenv("AI_PROVIDER", "deepseek")               # "openai", "deepseek", "gemini"
'''
...
llm_api_url = os.getenv("LLM_API_URL", "https://api.deepseek.com/v1")       # Examples: "https://api.openai.com/v1/", "http://127.0.0.1:1234/v1/", "http://localhost:1234/v1/", "https://api.deepseek.com", "https://api.deepseek.com/v1"
...
llm_api_key = os.getenv("LLM_API_KEY", "sk-c101c45ee7af44c19e77e9ff43f59bd9")              # Enter your API key in the quotes, make sure it's valid, if not will result in error.
'''
...
llm_model = os.getenv("LLM_MODEL", "deepseek-chat")          # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct", "qwen3:latest", "gemini-pro", "gemini-1.5-flash", "gemini-2.5-flash", "deepseek-llm:latest"
...
stream_output = os.getenv("STREAM_OUTPUT", "false").lower() == "true"                    # Examples: True or False. (False is recommended for performance, True is recommended for user experience!)
'''
