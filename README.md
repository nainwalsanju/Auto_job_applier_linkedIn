...
## 📽️ See it in Action
[![Auto Job Applier demo video](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/assets/100998531/429f7753-ebb0-499b-bc5e-5b4ee28c4f69)](https://youtu.be/gMbB1fWZDHw)
...
4. Clone the current git repo or download it as a zip file, url to the latest update https://github.com/nainwalsanju/Auto_job_applier_linkedIn.
...
### Code Guidelines
  ...
  New feature example
  ```python
  ##> ------ Sanjay Nainwal : godsscion - Feature ------
  ...
  ##> ------ Sanjay Nainwal : sanjaynainwal129@gmail.com - Bug fix ------
...
If you need to communicate about this project, feel free to share it with your network!
...
Copyright (C) 2024 Sanjay Nainwal  <sanjaynainwal129@gmail.com>
...
- **GitHub**
    - [All Discussions](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions)
    - [Announcements](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/announcements)
    - [General](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/general)
    - [Feature requests or Ideas](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/feature-requests-or-ideas)
    - [Polls](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/polls)
    - [Community Flex](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/community-flex)
    - [Support Q&A](https://github.com/nainwalsanju/Auto_job_applier_linkedIn/discussions/categories/support-q-a)
