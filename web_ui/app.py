...
def generate_logs():
    """Generator for streaming log file content."""
    if not os.path.exists(LOG_PATH):
        yield "data: [WAITING] Log file not found yet. Starting soon...\n\n"
...
def stream_logs():
    """Endpoint for Server-Sent Events log streaming."""
...
def get_applied_jobs():
    ...
    try:
        jobs = []
        with open(
            PATH + "all_applied_applications_history.csv", "r", encoding="utf-8"
        ) as file:
